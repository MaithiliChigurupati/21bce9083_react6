            ...
            <div ref={home} class="home">
                  <h3 class="heading">Home</h3>
                   <table>
                    ...
                    <h3 class="i1">I am Maithili</h3>
                    <h3 class="i1">Welcome to my portfolio website</h3>
                    <h3 class="i1">My resume link <a href="https://drive.google.com/file/d/1_b8v897yNfsRrbwbVBbLAkh8eAtzX-cE/view?usp=sharing" target="_blank" rel="noreferrer" >It's here</a></h3>
...
that.</h4>
            ...
            <div ref={contact} class="contact">
                ...
                <h4>Email me at maithili.chigurupati@gmail.com</h4>
                <h4>Contact Number 7981875298</h4>
                <h4>My GitHub link <a href="https://github.com/maithilichigurupati">It's here</a></h4>
                <h4>Instagram Id @maithili__chigurupati</h4>
            </div>
        </div>
    )
}